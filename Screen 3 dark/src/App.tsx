    ...
    <div>
      <div className="bg-neutral-950 text-neutral-50 w-full h-fit h-fit min-h-screen w-screen min-w-screen max-w-screen overflow-visible">
        <div className="px-5 pt-8 pb-6">
          <h1 className="font-serif font-normal text-[#faf9f5] text-4xl leading-[41px] tracking-[-0.5px]" />
          <div className="rounded-2xl bg-[#252320] flex mt-6 p-8 flex-col items-center">
            <div className="relative w-50 h-27.5 overflow-hidden">
              <div className="rounded-t-full bg-[#181715] absolute inset-0" />
              ...
              <div className="rounded-t-full bg-[#252320] absolute inset-x-6 top-6 bottom-0" />
              <div className="flex absolute inset-x-0 bottom-0 pb-1 flex-col justify-end items-center">
                <span className="leading-none font-serif font-normal text-[#faf9f5] text-4xl leading-10">
                  68
                </span>
              </div>
            </div>
          ...
          <div className="rounded-xl bg-[#252320] mt-4 p-6">
            ...
            <div className="flex mt-3 flex-wrap gap-x-4 gap-y-1">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-medium text-[#a09d96] text-[13px]">
                  TikTok
                </span>
              </div>
              <div className="flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-2 mt-4 gap-4">
            <div className="rounded-xl bg-[#252320] p-5">
              <p className="font-medium uppercase text-[#a09d96] text-xs leading-[17px] tracking-[1.5px]">
                Total Videos
              </p>
              <p className="font-serif font-normal text-[#faf9f5] text-[28px] leading-[34px] tracking-[-0.3px] mt-2">
                94
              </p>
            </div>
            <div className="rounded-xl bg-[#252320] p-5">
          ...
          <div className="grid grid-cols-2 mt-4 gap-4">
            <div className="rounded-xl bg-[#252320] p-4">
              ...
              <p className="font-medium text-[#faf9f5] text-base leading-[22px] mt-3">
                Wednesday
              </p>
              <p className="text-[#a09d96] text-sm leading-[22px] mt-0.5">
                8 videos
              </p>
            </div>
            <div className="rounded-xl bg-[#252320] p-4">
        ...
        <div className="sticky border-[oklch(1_0_0/10%)] bg-[#181715] border-black/1 border-t-1 border-r-0 border-b-0 border-l-0 border-solid flex bottom-0 px-5 pt-3 pb-6 justify-around items-center">
          ...
          <div className="text-[#a09d96] flex flex-col items-center gap-1">
            ...
            <span className="font-medium text-xs leading-4">Focus</span>
          </div>
          <div className="text-[#cc785c] flex flex-col items-center gap-1">
            <ChartColumn className="size-5" />
            <span className="font-medium text-xs leading-4">Stats</span>
          </div>
          <div className="text-[#a09d96] flex flex-col items-center gap-1">
            <Settings className="size-5" />
            <span className="font-medium text-xs leading-4">Settings</span>
          </div>
        </div>
      </div>
    </div>
